...
public class BackGroundDef {
    private int width;
    private int height;
    public int[] bgtiles = new int[4];
    
    public BackGroundDef(GL2 gl,int[] tileSize){
        //load all tiles
        bgtiles[0] = glTexImageTGAFile(gl, "grass.tga", tileSize);   // picture dont work
        bgtiles[1] = glTexImageTGAFile(gl, "blueTile.tga", tileSize);
        bgtiles[2] = glTexImageTGAFile(gl, "redTile.tga", tileSize);
        bgtiles[3] = glTexImageTGAFile(gl, "greenTile.tga", tileSize);
